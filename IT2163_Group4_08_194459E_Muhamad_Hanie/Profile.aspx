<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="IT2163_Group4_08_194459E_Muhamad_Hanie.Profile" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h2 class="auto-style11">Account Details</h2>
            <p>&nbsp;</p>
        </div>
        <table class="auto-style2">
            ...
            <tr>
                <td class="auto-style1">&nbsp;</td>
                <td class="auto-style6">
                    <asp:Button ID="btnCheckPassword" runat="server" causesvalidation="False" ValidationGroup="valGroup2" OnClick="btnCheckPassword_Click" Text="Edit" Width="218px" />
                </td>
                <td class="auto-style9">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style9">
                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Save Changes" Width="158px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">&nbsp;</td>
